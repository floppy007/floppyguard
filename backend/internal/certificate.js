...
// upstream fixed container paths.
const letsencryptRoot = process.env.NPM_LETSENCRYPT_ROOT || "/etc/letsencrypt";
const customSslRoot = process.env.NPM_CUSTOM_SSL_ROOT || "/data/custom_ssl";
