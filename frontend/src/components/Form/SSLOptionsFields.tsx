...
export function SSLOptionsFields({
	...
	const toggleCardClasses = "card border-0 shadow-sm h-100";
	const toggleCardBodyClasses = "card-body py-3 px-3";
			...
			<div className="row">
				<div className="col-6">
					<Field name="sslForced">
						{({ field }: any) => (
							<div className={toggleCardClasses}>
								<div className={toggleCardBodyClasses}>
			...
			{newCertificate ? (
				<>
					<Field name="meta.dnsChallenge">
						{({ field }: any) => (
							<div className={`${toggleCardClasses} mt-3`}>
								<div className={toggleCardBodyClasses}>
									<label className="form-check form-switch mt-1">
										<input
